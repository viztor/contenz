...
export function parseLocaleFromURL(
  ...
  if (strategy === "query") {
    ...
    if (paramValue) {
      ...
      // Optimization: For small collections (like locales), iterating with Array.find()
      // is faster than instantiating a new Set/Map on every function call.
  ...
  // Optimization: Iterating with Array.find() prevents allocation overhead for Sets/Maps.
...
export function negotiateLocale(
  ...
  // Optimization: Prioritizing Array.find() iterations over Set/Map allocations
  // reduces garbage collection pressure on this hot path.
