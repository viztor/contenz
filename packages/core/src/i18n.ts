...
export function resolveI18nEntry<T>(
  ...
  // ⚡ Bolt: Use an Array instead of Set for small lookups bounded by MAX_FALLBACK_DEPTH (5)
  // to avoid redundant memory allocations and garbage collection pressure in this hot path.
