...
// ⚡ Bolt: Cache compiled RegExp objects for parseFileName to avoid recompiling them for every file
const fileNameRegexCache = new Map<string, RegExp>();
...
export function parseFileName(
  ...
  let regex = fileNameRegexCache.get(cacheKey);
  ...
  if (!regex) {
    ...
    fileNameRegexCache.set(cacheKey, regex);
  }
