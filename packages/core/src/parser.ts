...
/** Statically compiled regex for locales to avoid recompiling on every file */
...
export function parseFileName(
  ...
  // ⚡ Bolt: Optimization - Use string manipulation (endsWith) instead of instantiating
  // dynamic RegExps for every file. Finds the longest matching extension for multi-dot support.
