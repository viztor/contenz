...
/** Cache for reuse of compiled RegExp objects in parsing filenames */
...
export function parseFileName(
  ...
  // ⚡ Bolt: Cache compiled RegExp objects for significant performance gains
  // when parsing thousands of content files. We avoid 'g' and 'y' flags to
  // safely reuse the RegExp without stateful lastIndex issues.
