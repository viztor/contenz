...
export function parseFileName(
  ...
  // ⚡ Bolt Optimization: Cache compiled RegExp objects
  // This prevents expensive redundant RegExp compilations in the hot loop
  // as this function is called for every single content file.
