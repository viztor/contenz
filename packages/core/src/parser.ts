...
// Static RegExp for validating BCP 47 locales: xx, xxx, xx-XX, xx-Xxxx, xx-Xxxx-XX, etc.
 ...
 *
 * Optimized to avoid dynamic RegExp instantiation and use string manipulation for performance.
 */
