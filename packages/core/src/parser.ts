...
// Bolt ⚡: Pre-compute default extension alternation string to avoid `.map` on every parse
...
// Bolt ⚡: Cache compiled regex patterns to avoid `new RegExp` constructor overhead in hot loops
