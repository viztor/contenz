...
/** Pre-computed alternation for default extensions to avoid rebuilding the string on every call */
...
/** Cache for compiled filename parsing regular expressions to prevent recreation in hot loops */
