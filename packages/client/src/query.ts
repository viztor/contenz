...
// biome-ignore lint/suspicious/noExplicitAny: Required for broad generic support
export class QueryBuilder<T extends Record<string, any>> {
	...
	// biome-ignore lint/suspicious/noExplicitAny: Value can be of any type for filtering
